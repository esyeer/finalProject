...
WebUI.setText(findTestObject('Object Repository/Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_email'), 'faceluck04256@gmail.com')
...
WebUI.verifyElementText(findTestObject('Object Repository/Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/Validate_Email sudah  terdaftar'), 'Email sudah terdaftar.')
