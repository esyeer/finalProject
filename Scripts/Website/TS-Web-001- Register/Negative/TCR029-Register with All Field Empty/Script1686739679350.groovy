...
//WebUI.delay(2)
//
//WebUI.setText(findTestObject('Object Repository/Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_email'),
//	'abcd@gmail.com')
//
//WebUI.delay(2)
//
...
WebUI.verifyElementAttributeValue(findTestObject('Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_name'), 
    'value', '', 10)
...
WebUI.verifyElementAttributeValue(findTestObject('Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_email'), 
    'value', '', 10)

WebUI.verifyElementAttributeValue(findTestObject('Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_whatsapp'), 
    'value', '', 10)

WebUI.verifyElementAttributeValue(findTestObject('Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_password'), 
    'value', '', 10)

WebUI.verifyElementAttributeValue(findTestObject('Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_password_confirmation'), 
    'value', '', 10)

WebUI.verifyElementNotChecked(findTestObject('Object Repository/Website/Register/Page_Buat akun dan dapatkan akses di Coding.ID/Checkbox_agreement'), 
    2)
