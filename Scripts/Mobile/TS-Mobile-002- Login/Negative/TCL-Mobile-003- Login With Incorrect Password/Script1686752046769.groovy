...
Mobile.setText(findTestObject('Object Repository/Mobile/Login/field_pass'), 'Incorrect', 1)

Mobile.tap(findTestObject('Object Repository/Mobile/Login/Button_Login'), 1)

Mobile.delay(5)

Mobile.verifyElementVisible(findTestObject('Object Repository/Mobile/Login/element_popUp'), 5)
