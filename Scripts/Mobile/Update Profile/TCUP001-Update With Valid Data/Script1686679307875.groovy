...
Mobile.startApplication('C:\\Users\\ACER\\Videos\\Demo-App.apk', true)

Mobile.tap(findTestObject('Object Repository/Mobile/Login/Button_LoginHere'), 0)

//Mobile.tap(findTestObject('Object Repository/Mobile/Login/field_email'), 0)

Mobile.setText(findTestObject('Object Repository/Mobile/Login/field_email'), GlobalVariable.email, 0)

//Mobile.tap(findTestObject('Object Repository/Mobile/Login/field_Password'),0)

Mobile.setText(findTestObject('Object Repository/Mobile/Login/field_Password'), GlobalVariable.password, 0)
